...
import com.kirkyweather.android.KirkyWeatherApplication.Companion.context
...
class PlaceAdapter(private val viewModel: PlaceViewModel, private val placeList: List<Place>) :
